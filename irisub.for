...
C7118  height=height+heistp
C     kk=kk+1
C     if(kk.le.numhei) goto 300

C     PRINT *, 'ELEDE: ', ELEDE

7118  kk=kk+1
      height=alt_values(kk)
...
c       This part is reached only if ivar != 1        
c       height is the hxx parameter from iritest            
...
c       Here the varying variable is set to its first value
        xvar(ivar)=vbeg
